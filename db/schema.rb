...
ActiveRecord::Schema.define(version: 20160728183919) do
  ...
  create_table "service_centre_slots", force: :cascade do |t|
    t.integer  "service_centre_id", limit: 4, null: false
  ...
  create_table "service_types", force: :cascade do |t|
    ...
    t.integer  "service_cost", limit: 4,     null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at",                                                   null: false
    t.datetime "updated_at",                                                   null: false
    t.string   "role",                   limit: 40,    default: "super_admin", null: false
  end
  ...
  create_table "vehicles", force: :cascade do |t|
    ...
    t.text     "model",        limit: 65535, null: false
    t.string   "number",       limit: 255,   null: false
    t.text     "owner_name",   limit: 65535, null: false
